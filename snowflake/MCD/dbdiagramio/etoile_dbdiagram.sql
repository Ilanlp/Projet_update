...
Table Faits_Offres {
  id_offre int [pk]
  id_contrat int [ref: > Dim_Contrat.id_contrat]
  id_lieu int [ref: > Dim_Lieu.id_lieu]
  id_date int [ref: > Dim_Date.id_date]
  id_entreprise int [ref: > Dim_Entreprise.id_entreprise]
  id_domaine int [ref: > Dim_Domaine.id_domaine]
  id_teletravail int [ref: > Dim_Teletravail.id_teletravail]
  id_niveau int [ref: > Dim_Seniorite.id_niveau]
  id_rome int [ref: > Dim_ROME.id_rome]
  salaire int
  source varchar(50)
  date_publication datetime
  date_mise_a_jour datetime
  nb_competences_requises int
  nb_soft_skills int
  description text
...
Table Dim_Entreprise {
  ...
  nom text
  type_entreprise varchar(30)
  domaine_entreprise varchar(50)
...
Table Offre_CompetenceTech {
  id_offre int [ref: > Faits_Offres.id_offre, pk]
  id_competence int [ref: > Dim_CompetenceTech.id_competence, pk]
}

Table Dim_SoftSkills {
  id_soft_skills int [pk]
  nom_skill varchar(50)
}

Table Offre_SoftSkills {
  id_offre int [ref: > Faits_Offres.id_offre, pk]
  id_soft_skills int [ref: > Dim_SoftSkills.id_soft_skills, pk]
}
...
Table Formation_Competence {
  id_formation int [ref: > Formation.id_formation, pk]
  id_competence int [ref: > Dim_CompetenceTech.id_competence, pk]
}

Table Competence_Domaine {
  id_competence int [ref: > Dim_CompetenceTech.id_competence, pk]
  id_domaine int [ref: > Dim_Domaine.id_domaine, pk]
  poids int
}
